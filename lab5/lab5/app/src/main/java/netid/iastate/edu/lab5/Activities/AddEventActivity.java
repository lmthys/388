...
import netid.iastate.edu.lab5.Models.EventDao;
...
public class AddEventActivity extends Activity {
    ...
    public void addEvent(View view) {
        ...
        int i = 0;
        String start = formatDateTime(startDate.getMonth(), startDate.getDayOfMonth(), startDate.getYear(), startTime.getHour(), startTime.getMinute());
        String end = formatDateTime(endDate.getMonth(), endDate.getDayOfMonth(), endDate.getYear(), endTime.getHour(), endTime.getMinute());
        Event e = new Event(titleText.getText().toString(), locText.getText().toString(), start, end, detailText.getText().toString());
